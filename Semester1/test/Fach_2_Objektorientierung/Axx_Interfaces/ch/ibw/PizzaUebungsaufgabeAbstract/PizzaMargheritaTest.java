...
import Fach_2_Objektorientierung.Axx_Interfaces.ch.ibw.PizzaUebungsaufgabeInterface.PizzaMargherita;
...
public class PizzaMargheritaTest {
    ...
    public void preisTestKleinePizza(){
        Fach_2_Objektorientierung.Axx_Interfaces.ch.ibw.PizzaUebungsaufgabeInterface.PizzaMargherita p = new Fach_2_Objektorientierung.Axx_Interfaces.ch.ibw.PizzaUebungsaufgabeInterface.PizzaMargherita();
        p.setGroesse("klein");
    ...
    public void zutatenBasisTestMitAnzahlZutaten(){
        Fach_2_Objektorientierung.Axx_Interfaces.ch.ibw.PizzaUebungsaufgabeInterface.PizzaMargherita p = new PizzaMargherita();
